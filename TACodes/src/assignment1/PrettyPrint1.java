...
public class PrettyPrint1 {
	...
	// one loop-- using string builder.... why stringBuilder??why not
	// Strings??why not StringBuffer???
	// Complexity??? append()--O(1) insert()--O(n)(char[] is used in
	// StringBuilder)
